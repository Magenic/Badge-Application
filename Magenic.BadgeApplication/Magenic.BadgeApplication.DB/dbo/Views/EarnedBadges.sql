...
SELECT     TOP (100) PERCENT dbo.Employee.EmployeeId, dbo.Employee.FirstName, dbo.Employee.LastName, dbo.Employee.AwardPayoutThreshold, dbo.Employee.ADName, 
                      ...
                      dbo.Badge.BadgeApprovedById, dbo.Badge.BadgeApprovedDate, dbo.BadgeType.BadgeTypeName, dbo.BadgeType.PayrollEligible,
					  dbo.BadgeAward.AwardDate, dbo.BadgeAward.AwardAmount, dbo.BadgeAward.PaidOut, dbo.BadgeAward.BadgeAwardId
