...
SELECT     TOP (100) PERCENT dbo.Employee.EmployeeId, dbo.Employee.FirstName, dbo.Employee.LastName, dbo.Employee.AwardPayoutThreshhold, dbo.Employee.ADName, 
                      dbo.Badge.BadgeId, dbo.Badge.BadgeName, dbo.Badge.BadgeTagLine, dbo.Badge.BadgeDescription, dbo.Badge.BadgeTypeId, dbo.Badge.BadgeImage, 
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'EarnedBadges';
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'EarnedBadges';
